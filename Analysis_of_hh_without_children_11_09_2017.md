...
![](Analysis_of_hh_without_children_11_09_2017_files/figure-markdown_github/unnamed-chunk-7-1.png)
...
```
    ...
    ## 
    ## Call:
    ## mirt(data = items2, model = 1, itemtype = "Rasch", survey.weights = dat$weighth)
    ## 
    ## Full-information item factor analysis with 1 factor(s).
    ...
    ## Number of rectangular quadrature: 61
    ## 
    ## Log-likelihood = -176849886
    ## Estimated parameters: 9 
    ## AIC = 353699790; AICc = 353699790
    ## BIC = 353699942; SABIC = 353699913
    ## G2 (246) = 50108119, p = 0
...
```
    ...
    ## $items
    ##           a1       d g u
    ## Item2  7.031  -8.325 0 1
    ## Item3  7.322  -9.563 0 1
    ## Item4  4.856  -6.448 0 1
    ## Item8  7.790 -12.484 0 1
    ## Item9  8.616 -13.556 0 1
    ## Item10 7.009 -13.219 0 1
    ## Item11 5.536 -11.656 0 1
...
![](Analysis_of_hh_without_children_11_09_2017_files/figure-markdown_github/unnamed-chunk-9-1.png)

``` r
plot(fit.2pl.final, type = 'trace')
```

![](Analysis_of_hh_without_children_11_09_2017_files/figure-markdown_github/unnamed-chunk-9-2.png)
